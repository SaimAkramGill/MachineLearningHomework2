...
def task_1():
    features = np.load('C:/Saim_Files/TU GRAZ/Semester 2/Machine Learning/Assignment 2/ML1_HW2/data/brain_tumor_images.npy')
    targets = np.load('C:/Saim_Files/TU GRAZ/Semester 2/Machine Learning/Assignment 2/ML1_HW2/data/brain_tumor_targets.npy')
